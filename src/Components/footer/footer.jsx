...
const footer = () => {
  return (
    ...
    <div className='home_sub1_main'>
     ...
     <div style={{ backgroundColor: "ghostwhite", width: "98%", margin: "auto", marginTop: "10px"}}>
         <div style={{marginBottom: "6px"}}>
             <span style={{marginLeft: "1px"}}><small>CIN: U66000KA2016PLC138288</small></span>
             <span style={{marginLeft: "15px"}}><small>IRDAI Registration No: 157</small></span>
             <span style={{marginLeft: "15px"}}><small>Category: Non-Life Insurance</small></span>
         </div>

         <small style={{size: "6px"}}>The use of images and brands are only for the purpose of indication and illustration. ACKO claims no
